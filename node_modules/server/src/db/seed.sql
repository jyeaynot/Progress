...
TRUNCATE TABLE crop_records RESTART IDENTITY CASCADE;
...
VALUES
  (
    ...
    1.50,
    'Growing',
    'Main wet season plot'
  ),
  (
    'f0f0f0f0-5555-6666-7777-888888888888',
    '22222222-2222-2222-2222-222222222222',
    'Corn',
    '2026-04-20',
    '2026-07-10',
  ...
  (
    'f0f0f0f0-9999-aaaa-bbbb-cccccccccccc',
    '33333333-3333-3333-3333-333333333333',
    'Coconut',
    '2026-01-15',
    '2026-12-31',
  ...
  (
    'f0f0f0f0-dddd-eeee-ffff-000000000001',
    '44444444-4444-4444-4444-444444444444',
    'Vegetables',
    '2026-05-08',
    '2026-06-25',
    0.80,
    'Growing',
    'Mixed vegetable demo farm'
  ),
  (
    'f0f0f0f0-0000-1111-2222-333333333333',
    '55555555-5555-5555-5555-555555555555',
    'Rice',
    '2026-05-03',
    '2026-08-28',
