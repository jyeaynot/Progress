...
import type { SupabaseAuthRequest } from "../middleware/requireSupabaseAuth.js";

export async function getCurrentUser(req: SupabaseAuthRequest, res: Response) {
  try {
...
export async function upsertCurrentUserProfile(req: SupabaseAuthRequest, res: Response) {
  try {
    const userId = req.supabaseUser?.sub;
